...
app.get("/o/:id", (req, res) => {
  const frontendBaseUrl = (process.env.STORE_URL || "http://localhost:3000, http://localhost:8081, exp://192.168.1.5:8081, http://192.168.1.9:8092/api, http://192.168.1.9:8091/api, http://192.168.1.9:8081, exp://192.168.1.9:8081").replace(/\/+$/, "");
