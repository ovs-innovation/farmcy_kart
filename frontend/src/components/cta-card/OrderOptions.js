      ...
      <div className="w-full max-w-3xl mx-auto mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <a
            ...
            className="flex items-center p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors cursor-pointer group"
          >
            <div className="bg-white p-3 rounded-lg shadow-sm text-blue-600 group-hover:text-blue-700">
              <IoCallOutline className="text-2xl" />
            </div>
            <span className="ml-4 text-gray-700 font-medium">
              Call <span className="font-bold text-gray-900">09240250346</span>{" "}
              to place order
            </span>
          </a>
          ...
          <button
            ...
            className="flex items-center p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors cursor-pointer group w-full text-left"
          >
            <div className="bg-white p-3 rounded-lg shadow-sm text-blue-600 group-hover:text-blue-700">
