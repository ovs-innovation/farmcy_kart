    ...
    <>
      <AnimatedContent>
        ...
        <div className="flex items-center gap-2 mb-4">
          <FiBox className="text-gray-800 text-[22px]" />
            ...
            <form onSubmit={handleAddAttribute} className="p-6 md:p-8 flex flex-col gap-6">
              ...
              <div className="flex justify-end gap-3 mt-4">
                <button
                  ...
                  className="px-8 py-2.5 rounded-xl text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors"
                >
                  Reset
                </button>
                <button
          ...
          <CardBody className="p-0">
            <div className="p-5 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                ...
                <button className="flex items-center gap-2 px-4 h-11 rounded-xl border border-gray-200 hover:bg-gray-50 text-gray-600 font-medium text-sm transition-all whitespace-nowrap bg-white">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-gray-500"><path d="M4 17V19C4 19.5304 4.21071 20.0391 4.58579 20.4142C4.96086 20.7893 5.46957 21 6 21H18C18.5304 21 19.0391 20.7893 19.4142 20.4142C19.7893 20.0391 20 19.5304 20 19V17M7 11L12 16M12 16L17 11M12 16V4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              ...
              <TableContainer className="mb-0 border-none">
                <Table className="w-full whitespace-nowrap text-sm text-left">
                  <TableHeader className="bg-gray-50/50 dark:bg-gray-800/50">
                    <tr>
                      <TableCell className="px-6 py-4 font-bold text-gray-700 w-24">Sl <span className="text-gray-300 ml-1">↕</span></TableCell>
                      <TableCell className="px-6 py-4 font-bold text-gray-700 w-32">ID <span className="text-gray-300 ml-1">↕</span></TableCell>
                      <TableCell className="px-6 py-4 font-bold text-gray-700">Name <span className="text-gray-300 ml-1">↕</span></TableCell>
                      <TableCell className="px-6 py-4 font-bold text-gray-700 text-center w-32">Action <span className="text-gray-300 ml-1">↕</span></TableCell>
                    </tr>
                  </TableHeader>
                  <AttributeTable
