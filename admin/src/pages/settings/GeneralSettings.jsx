              ...
              <div className="flex-grow scrollbar-hide w-full max-h-full">
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    <InputAreaTwo
                      ...
                      name="gstin"
                      type="text"
                      placeholder="GSTIN (e.g. 07ABBCCA6074H1ZP)"
                    />
                    <Error errorName={errors.gstin} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    ...
                    />
                    <Error errorName={errors.fssai_license_number} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    <InputAreaTwo
                      ...
                      name="doctor"
                      type="text"
                      placeholder="Doctor Name (e.g. Dr. Addanki Haripriya)"
                    />
                    <Error errorName={errors.doctor} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    <InputAreaTwo
                      ...
                      name="dl_number"
                      type="text"
                      placeholder="Drug License Number(s)"
                    />
                    <Error errorName={errors.dl_number} />
                  </div>
                </div>
