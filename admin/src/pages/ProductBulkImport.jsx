...
const ProductBulkImport = () => {
  ...
  return (
    <AnimatedContent>
      <div className="bg-[#f8fafc] min-h-screen pb-12 pt-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-xl font-extrabold text-[#1e293b] tracking-tight">Items Bulk Import</h1>
          </div>

          {/* Steps Section Container */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {/* Step 1 */}
            <Card className="rounded-2xl border-none shadow-sm hover:shadow-md transition-shadow bg-white overflow-hidden">
              <CardBody className="p-7">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <h3 className="text-[15px] font-bold text-[#1e293b] mt-2">Download Template</h3>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="text-[12.5px] text-[#475569] space-y-2 leading-relaxed">
              ...
              <Card className="rounded-2xl border-none shadow-sm bg-white h-full overflow-hidden">
                <CardBody className="p-8">
                  ...
                  <div className="space-y-4">
                    <label 
                      className={`flex items-center justify-between p-5 rounded-2xl cursor-pointer transition-all border-2 ${uploadType === 'new' ? 'border-teal-100 bg-teal-50/20' : 'border-slate-50 hover:border-slate-100 hover:bg-slate-50/30'}`}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-[14px] font-bold ${uploadType === 'new' ? 'text-[#1e293b]' : 'text-[#64748b]'}`}>Upload New Data</span>
                      </div>
                    ...
                    <label 
                      className={`flex items-center justify-between p-5 rounded-2xl cursor-pointer transition-all border-2 ${uploadType === 'update' ? 'border-teal-100 bg-teal-50/20' : 'border-slate-50 hover:border-slate-100 hover:bg-slate-50/30'}`}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-[14px] font-bold ${uploadType === 'update' ? 'text-[#1e293b]' : 'text-[#64748b]'}`}>Update Existing Data</span>
                      </div>
                ...
                <CardBody className="p-8 flex flex-col">
                  ...
                  <div 
                    ...
                    className={`flex-1 min-h-[160px] border-2 border-dashed rounded-2xl flex flex-col items-center justify-center p-8 transition-all cursor-pointer relative group
                      ${selectedFile ? 'border-teal-200 bg-teal-50/20' : 'border-slate-100 bg-slate-50/20 hover:bg-teal-50/10 hover:border-teal-200'}`}
                  >
                    {!selectedFile ? (
                       <>
                         <div className="p-5 bg-white rounded-2xl shadow-sm mb-5 text-[#008f89] group-hover:scale-110 transition-transform duration-300">
                            <FiUploadCloud className="w-10 h-10" />
                         </div>
                         <p className="text-[14px] font-bold text-[#475569] mb-1">Click or drag file to upload</p>
                       ...
                       <div className="flex flex-col items-center animate-scale-in">
                         ...
                         <p className="text-[15px] font-extrabold text-[#1e293b] truncate max-w-[300px] mb-1">{selectedFile.name}</p>
          ...
          {/* Action Buttons */}
          <div className="flex justify-end gap-5 mb-12 p-6 bg-white rounded-2xl shadow-sm border border-slate-50">
            <Button 
              onClick={handleResetUpload} 
              className="h-12 px-12 bg-slate-100 hover:bg-slate-200 text-white rounded-xl font-extrabold text-[11px] uppercase tracking-widest transition-all border-none"
            >
              Reset
            </Button>
            <Button 
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-10 overflow-hidden relative">
            ...
            <div className="flex items-center gap-3 mb-8 relative">
                ...
                <h3 className="text-xl font-extrabold text-[#1e293b] tracking-tight">Generate Variation Values</h3>
            </div>
            
            {isAlertVisible && (
               <div className="bg-[#f0f9ff] border border-[#bae6fd] text-[#0ea5e9] p-6 rounded-2xl flex items-start text-[13px] mb-8 relative transition-all group overflow-hidden">
                 <div className="absolute top-0 left-0 w-1 bg-[#0ea5e9] h-full"></div>
                 <div className="p-2 bg-white rounded-xl shadow-sm mr-4 text-[#0ea5e9]">
                    <FiInfo className="w-5 h-5" />
                 </div>
                 <div className="flex-grow">
                    <p className="font-extrabold text-[#0369a1] mb-1 uppercase tracking-wider text-[11px]">Pro Tip!</p>
                    <p className="leading-relaxed text-[#0c4a6e] font-medium text-justify pr-10">
            ...
            <div className="flex flex-col lg:flex-row items-end gap-6 mb-10">
              <div className="flex-grow w-full">
                ...
                <Select 
                   ...
                   className="w-full border-slate-200 bg-slate-50/30 text-[#1e293b] h-12 rounded-xl px-4 shadow-sm focus:border-[#008f89] focus:ring focus:ring-teal-100 transition-all font-bold text-[13px]"
                >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
               <div className="space-y-3">
                 <label className="text-[12px] font-bold text-[#475569] flex items-center justify-between px-1">
                 ...
                 <Textarea 
                   ...
                   className="w-full border-slate-200 bg-slate-50/50 min-h-[110px] p-4 rounded-2xl text-[#1e293b] font-mono text-[12px] focus:ring-0 cursor-text shadow-inner transition-all hover:bg-slate-50" 
                 />
            ...
            <div className="flex justify-end pt-4 border-t border-slate-50">
               <Button 
                ...
                className="h-10 px-10 bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-500 rounded-xl font-extrabold text-[10px] uppercase tracking-widest transition-all border-none"
               >
                 Clear Output
               </Button>
            </div>
